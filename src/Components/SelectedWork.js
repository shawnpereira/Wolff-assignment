  ...
  return (
    <div>
      <div class="grid md:grid-cols-12 gap-5 md:gap-x-0">
        ...
        <div
          data-start-y="15"
          class="align-center relative flex h-full w-full flex-col md:col-span-full md:pl-2.5 transition-transform ease-quint duration-[1200ms] transform translate-y-0"
        >
          <a
            class="group cursor-swarr"
            rel="noreferrer"
          ...
          >
            ...
            <div>
              <h2 class="mt-5 text-lg leading-120">Jack Daniel's</h2>
              <div>
                <p class="mb-3 mt-2 text-lg leading-120 text-gray-300">
                  Every drop a tale
                </p>
                <div class="tags mt-3 flex select-none flex-wrap gap-x-1 gap-y-2 text-sm text-gray-300">
                  <span class="mr-1 border border-gray-300 px-4">Alcohol</span>
                  <span class="rounded-full border border-gray-300 px-3">
                    Brand Strategy
                  </span>
                  <span class="rounded-full border border-gray-300 px-3">
        ...
        >
          ...
          >
            ...
            <div>
              <h2 class="mt-5 text-lg leading-120">
